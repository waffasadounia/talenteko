 ...
 *
 * UX / Accessibilité :
 * - Feedback en direct avec icônes Font Awesome (✔️ / ❌).
 * - aria-live="polite" + role="status" pour retour lecteur d’écran.
...
export default class extends Controller {
  ...
  connect() {
    // Prépare la zone de feedback pour accessibilité
  ...
  check() {
    ...
    if (!confirm) {
      // Champ vide – reset feedback + validation
