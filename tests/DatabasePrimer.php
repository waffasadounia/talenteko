...
/**
 * Utilitaire pour r̩initialiser la BDD de test.
 *
 * Deux modes possibles :
 * - primeDatabase() appel̩ dans setUpBeforeClass() pour reset global une seule fois.
 * - primeDatabase() appel̩ dans setUp() pour reset avant chaque test.
 */
