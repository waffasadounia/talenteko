...
final class Version20250905131922 extends AbstractMigration
{
    ...
    {
        return 'Aligne listing : renomme city en location et (re)crée index (title, location) en étant idempotent.';
    }
    ...
    public function up(Schema $schema): void
    {
        ...
        // 3) Créer un index stable (title, location) s’il n’existe pas déjà (peu importe le nom actuel)
    ...
    public function down(Schema $schema): void
    {
        ...
        // 1) Drop l’index (title, location) si présent (quel que soit son nom)
