...
#[UniqueEntity(fields: ['email'], message: 'Un compte existe dÃƒÂ©jÃƒÂ  avec cet email.')]
...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    #[Assert\Length(
        min: 10,
        minMessage: 'Votre mot de passe doit contenir au moins {{ limit }} caractÃƒÂ¨res.',
    )]
    #[Assert\Regex(
        pattern: "/^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)(?=.*[\W_]).+$/",
        message: 'Le mot de passe doit contenir au moins une majuscule, une minuscule, un chiffre et un caractÃƒÂ¨re spÃƒÂ©cial.',
    )]
    ...
    #[Assert\NotBlank(message: 'Merci dÃ¢â‚¬â„¢indiquer votre ville.')]
    ...
    public function __construct()
    {
        ...
        // GÃƒÂ©nÃƒÂ©ration auto du tag ÃƒÂ  4 chiffres
